 ...
 */
data class ApiResponse<T>(var errorCode: Int, var msg: String, var result: T, var successFlag:Boolean=false, var loginFlag:Boolean=false, var code:String) : BaseResponse<T>() {

    // 这里是示例，wanandroid 网站返回的 错误码为 0 就代表请求成功，请你根据自己的业务需求来改变
    override fun isSuccess() = successFlag
